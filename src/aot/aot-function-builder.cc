...
template <typename T>
void AOTFunctionBuilder::EmitIntRemainder(TR::IlBuilder *b)
   { //, const uint8_t* pc) {
   static_assert(std::is_integral<T>::value,
...
void AOTFunctionBuilder::EmitTruncation(TR::IlBuilder *b)
   { //, const uint8_t* pc) {
 ...
 */
template <typename ToType, typename FromType>
void AOTFunctionBuilder::EmitUnsignedTruncation(TR::IlBuilder *b)
   { // , const uint8_t* pc) {
